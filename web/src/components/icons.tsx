export function PlayIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M8 5.14v13.72c0 .94 1.03 1.51 1.83 1.01l10.7-6.86a1.2 1.2 0 0 0 0-2.02L9.83 4.13C9.03 3.63 8 4.2 8 5.14Z" />
    </svg>
  );
}
...
export function SkipBack10Icon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function SkipForward10Icon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
